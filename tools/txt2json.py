...
JSON_VAR['NNHALB'] = 'int'
JSON_VAR['FNHALB'] = 'int'
JSON_VAR['OHALBS'] = 'float'
JSON_VAR['NHALBS'] = 'float'
JSON_VAR['FHALBS'] = 'float'
JSON_VAR['OZCARB'] = 'float'
JSON_VAR['NZCARB'] = 'float'
JSON_VAR['FZCARB'] = 'float'
JSON_VAR['ORCARB'] = 'float'
JSON_VAR['NRCARB'] = 'float'
JSON_VAR['FRCARB'] = 'float'
JSON_VAR['TOZCARB'] = 'int'
JSON_VAR['TFZCARB'] = 'int'
